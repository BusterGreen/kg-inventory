const InventoryContainer = Vue.createApp({
    ...
    methods: {
        ...
        async closeInventory() {
            ...
            try {
                await axios.post("https://kg-inventory/CloseInventory", { name: inventoryName });
            } catch (error) {
        ...
        async handleDropOnInventoryContainer() {
            if (this.isOtherInventoryEmpty && this.dragStartInventoryType === "player") {
                ...
                try {
                    const response = await axios.post("https://kg-inventory/DropItem", {
                        ...newItem,
        ...
        async handlePurchase(targetSlot, sourceSlot, sourceItem, transferAmount) {
            try {
                const response = await axios.post("https://kg-inventory/AttemptPurchase", {
                    item: sourceItem,
        ...
        async useItem(item) {
            ...
            if (playerItemKey) {
                try {
                    await axios.post("https://kg-inventory/UseItem", {
                        inventory: "player",
                        item: item,
                    });
                    if (item.shouldClose) {
        ...
        async giveItem(item, quantity) {
            if (item && item.name) {
                ...
                if (playerHasItem) {
                    ...
                    try {
                        await axios.post("https://kg-inventory/GiveItem", {
                            item: selectedItem,
                            amount: amountToGive,
                        });
        ...
        inventoryError(slot) {
            ...
            axios.post("https://kg-inventory/PlayDropFail", {}).catch((error) => {
        ...
        openWeaponAttachments() {
            ...
            if (!this.showWeaponAttachments) {
                ...
                axios
                    .post("https://kg-inventory/GetWeaponData", JSON.stringify({ weapon: this.selectedWeapon.name, ItemData: this.selectedWeapon }))
                    .then((response) => {
        ...
        removeAttachment(attachment) {
            ...
            axios
                .post("https://kg-inventory/RemoveAttachment", JSON.stringify({ AttachmentData: attachment, WeaponData: this.selectedWeapon }))
                .then((response) => {
        ...
        postInventoryData(fromInventory, toInventory, fromSlot, toSlot, fromAmount, toAmount) {
            ...
            axios
                .post("https://kg-inventory/SetInventoryData", {
